...
Antes de qualquer tarefa, ler `.claude/CLAUDE.md` — esse arquivo é só ponto de entrada pra agentes externos (Codex, Amp, Cursor) que não auto-descobrem `.claude/`.
