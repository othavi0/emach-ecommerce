	...
	return (
		<section className="px-20 py-14">
			<div className="mx-auto max-w-[1080px]">
				...
				<div className="grid grid-cols-1 bg-near-black text-white md:grid-cols-[300px_1fr]">
					<div className="flex flex-col justify-center gap-2.5 border-white/12 border-b px-7 py-7 md:border-r md:border-b-0">
