...
- **Armadilhas do contrato aplicadas**: `width: max-content` em todo posicionado exceto produto; box do produto com dimensão explícita (desktop 60%/38%; posicionado mobile 32%/70%; pilha 38%/82%).
